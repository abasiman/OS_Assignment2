...
def main():
    ...
    fcfs_head_movements = fcfs(initial_position, requests_sorted.copy())
    print("FCFS Total Head Movements:", fcfs_head_movements)

    scan_head_movements = scan(initial_position, requests_sorted.copy(), num_cylinders)
    print("SCAN Total Head Movements:", scan_head_movements)

    cscan_head_movements = cscan(initial_position, requests_sorted.copy(), num_cylinders)
    print("C-SCAN Total Head Movements:", cscan_head_movements)
